...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=W2YFVYbJ#hsoMJvaHO0QYZ6wPUEAc0DYplP7NNTTtup69sDzk_aE' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '9473737373,9363636367' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "prageeth" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello ,  prageeth    I am alive now!!*" : process.env.ALIVE_MSG,
